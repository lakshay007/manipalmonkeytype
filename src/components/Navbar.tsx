          ...
          <div className="flex items-center space-x-4">
            {status === "loading" ? (
                ...
                {showDropdown && (
                  <div className="absolute right-0 mt-2 w-48 bg-gray-900 rounded-lg shadow-lg border border-gray-700 py-1">
                    ...
                    <button
                      ...
                      className="flex items-center space-x-2 px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-white w-full text-left"
                    >
              ...
              <button
                ...
                className="flex items-center space-x-2 bg-[#5865F2] hover:bg-[#4752C4] text-white px-4 py-2 rounded-lg font-medium transition-colors"
              >
